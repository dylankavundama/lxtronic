    ...
    <nav class="sidebar-nav">
        <div>
            ...
            <div class="nav-links">
                ...
                <a href="sales_history.php" class="nav-link <?= $current=='sales_history.php' ? 'active' : '' ?>">
        ...
        <div>
            ...
            <div class="nav-links">
                ...
                <a href="expenses.php" class="nav-link <?= $current=='expenses.php' ? 'active-danger' : '' ?>">
