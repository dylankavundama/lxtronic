...
?>
<div class="fixed left-0 top-0 h-full w-64 bg-slate-900 text-slate-300 flex flex-col shadow-2xl transition-all duration-300 z-50">
    <!-- Logo -->
    <div class="p-6 border-b border-slate-800 flex items-center gap-3">
        ...
        <span class="text-xl font-bold text-white tracking-tight">QuincaTech</span>
    </div>

    <!-- Navigation Groups -->
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-8">
        <div>
            <p class="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-4 px-2">Menu Principal</p>
            <nav class="space-y-1">
                <a href="dashboard.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all group <?= (basename($_SERVER['PHP_SELF']) == 'dashboard.php') ? 'bg-blue-600 text-white shadow-lg shadow-blue-900/20' : '' ?>">
                ...
                <a href="sales.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" stroke-width="2"></path></svg>
        ...
        <div>
            <p class="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-4 px-2">Catalogue & Stock</p>
            <nav class="space-y-1">
                <a href="products.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" stroke-width="2"></path></svg>
                    <span class="font-medium">Produits</span>
                </a>
                <a href="categories.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
        ...
        <div>
            <p class="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-4 px-2">Finance & Clients</p>
            <nav class="space-y-1">
                <a href="clients.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
        ...
        <div>
            <p class="text-[10px] uppercase font-bold text-slate-500 tracking-wider mb-4 px-2">Paramètres</p>
            <nav class="space-y-1">
                <a href="users.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-800 hover:text-white transition-all group">
    ...
    <div class="p-4 border-t border-slate-800 bg-slate-900/50">
        <div class="flex items-center gap-3 p-2 rounded-xl bg-slate-800/50">
            <div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center text-blue-700 font-bold uppercase">
                <?= substr($_SESSION['username'] ?? 'U', 0, 2) ?>
            </div>
            <div class="flex-1 min-w-0">
                <p class="text-sm font-bold text-white truncate"><?= $_SESSION['username'] ?? 'User' ?></p>
                <p class="text-[10px] text-slate-400 uppercase tracking-tighter"><?= $_SESSION['role'] ?? 'Seller' ?></p>
            </div>
            <a href="logout.php" class="text-slate-500 hover:text-red-500 transition-colors" title="Déconnexion">
