...
// --- DONNÉES ---
$accounts = $pdo->query("SELECT * FROM bank_accounts ORDER BY account_name ASC")->fetchAll();
        ...
        <div class="card">
            ...
            <div class="data-table-wrapper table-responsive">
                <table class="data-table">
                    <thead>
                        <tr><th>Date</th><th>Compte</th><th>Type</th><th>Montant</th><th>Description</th></tr>
                    </thead>
                    <tbody>
